...
Revision ID: 2fa20c68e3e4
Revises: 
Create Date: 2026-02-06 04:03:17.449632
...
def schema_upgrades() -> None:
    ...
    sa.Column('block_type', sa.String(length=50), server_default='special', nullable=False),
    ...
    op.create_table('exclusion_dates',
    sa.Column('id', sa.GUID(length=16), nullable=False),
    sa.Column('year', sa.Integer(), nullable=False),
    ...
    with op.batch_alter_table('exclusion_dates', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_exclusion_dates_date'), ['date'], unique=False)
        batch_op.create_index(batch_op.f('ix_exclusion_dates_year'), ['year'], unique=False)
    ...
    op.create_table('caregiver_magic_links',
    sa.Column('id', sa.GUID(length=16), nullable=False),
    ...
    sa.Column('created_at', sa.DateTimeUTC(timezone=True), nullable=False),
    sa.Column('updated_at', sa.DateTimeUTC(timezone=True), nullable=False),
    sa.ForeignKeyConstraint(['caregiver_id'], ['caregivers.id'], name=op.f('fk_caregiver_magic_links_caregiver_id_caregivers')),
    ...
    with op.batch_alter_table('caregiver_magic_links', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_caregiver_magic_links_caregiver_id'), ['caregiver_id'], unique=False)
        batch_op.create_index(batch_op.f('ix_caregiver_magic_links_token_hash'), ['token_hash'], unique=True)

    op.create_table('caregiver_sessions',
    sa.Column('id', sa.GUID(length=16), nullable=False),
    sa.Column('caregiver_id', sa.UUID(), nullable=False),
    sa.Column('token_hash', sa.String(length=64), nullable=False),
    sa.Column('expires_at', sa.DateTime(timezone=True), nullable=False),
    ...
    sa.Column('created_at', sa.DateTimeUTC(timezone=True), nullable=False),
    sa.Column('updated_at', sa.DateTimeUTC(timezone=True), nullable=False),
    sa.ForeignKeyConstraint(['caregiver_id'], ['caregivers.id'], name=op.f('fk_caregiver_sessions_caregiver_id_caregivers')),
    ...
    with op.batch_alter_table('caregiver_sessions', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_caregiver_sessions_caregiver_id'), ['caregiver_id'], unique=False)
        batch_op.create_index(batch_op.f('ix_caregiver_sessions_token_hash'), ['token_hash'], unique=True)
    ...
    sa.Column('created_at', sa.DateTimeUTC(timezone=True), nullable=False),
    sa.Column('updated_at', sa.DateTimeUTC(timezone=True), nullable=False),
    sa.CheckConstraint("(session_type = 'term' AND day_of_week IS NOT NULL) OR (session_type = 'special')", name=op.f('ck_sessions_ck_sessions_term_requires_schedule')),
    sa.CheckConstraint("session_type IN ('term','special')", name=op.f('ck_sessions_ck_sessions_type')),
    sa.CheckConstraint('day_of_week IS NULL OR day_of_week BETWEEN 0 AND 6', name=op.f('ck_sessions_ck_sessions_day_of_week_nullable')),
    sa.ForeignKeyConstraint(['location_id'], ['locations.id'], name=op.f('fk_sessions_location_id_locations')),
    sa.PrimaryKeyConstraint('id', name=op.f('pk_sessions'))
    )
    with op.batch_alter_table('sessions', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_sessions_archived'), ['archived'], unique=False)
        batch_op.create_index(batch_op.f('ix_sessions_session_type'), ['session_type'], unique=False)
    ...
    sa.Column('created_at', sa.DateTimeUTC(timezone=True), nullable=False),
    sa.Column('updated_at', sa.DateTimeUTC(timezone=True), nullable=False),
    sa.ForeignKeyConstraint(['caregiver_id'], ['caregivers.id'], name=op.f('fk_students_caregiver_id_caregivers')),
    sa.PrimaryKeyConstraint('id', name=op.f('pk_students'))
    )
    op.create_table('block_links',
    sa.Column('id', sa.GUID(length=16), nullable=False),
    ...
    sa.Column('created_at', sa.DateTimeUTC(timezone=True), nullable=False),
    sa.Column('updated_at', sa.DateTimeUTC(timezone=True), nullable=False),
    sa.ForeignKeyConstraint(['block_id'], ['blocks.id'], name=op.f('fk_block_links_block_id_blocks'), ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['session_id'], ['sessions.id'], name=op.f('fk_block_links_session_id_sessions'), ondelete='CASCADE'),
    ...
    with op.batch_alter_table('block_links', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_block_links_block_id'), ['block_id'], unique=False)
        batch_op.create_index(batch_op.f('ix_block_links_session_id'), ['session_id'], unique=False)
    ...
    sa.Column('block_id', sa.UUID(), nullable=False, comment='Which block this occurrence belongs to'),
    sa.Column('sa_orm_sentinel', sa.Integer(), nullable=True),
    sa.Column('created_at', sa.DateTimeUTC(timezone=True), nullable=False),
    sa.Column('updated_at', sa.DateTimeUTC(timezone=True), nullable=False),
    sa.CheckConstraint('starts_at < ends_at', name=op.f('ck_occurrences_ck_occurrences_time_valid')),
    sa.ForeignKeyConstraint(['block_id'], ['blocks.id'], name=op.f('fk_occurrences_block_id_blocks'), ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['session_id'], ['sessions.id'], name=op.f('fk_occurrences_session_id_sessions'), ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id', name=op.f('pk_occurrences'))
    )
    with op.batch_alter_table('occurrences', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_occurrences_block_id'), ['block_id'], unique=False)
        batch_op.create_index(batch_op.f('ix_occurrences_session_id'), ['session_id'], unique=False)
    ...
    sa.Column('created_at', sa.DateTimeUTC(timezone=True), nullable=False),
    sa.Column('updated_at', sa.DateTimeUTC(timezone=True), nullable=False),
    sa.ForeignKeyConstraint(['session_id'], ['sessions.id'], name=op.f('fk_session_staff_session_id_sessions'), ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['staff_id'], ['staff.id'], name=op.f('fk_session_staff_staff_id_staff'), ondelete='CASCADE'),
    ...
    with op.batch_alter_table('session_staff', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_session_staff_session_id'), ['session_id'], unique=False)
        batch_op.create_index(batch_op.f('ix_session_staff_staff_id'), ['staff_id'], unique=False)
    ...
    sa.Column('created_at', sa.DateTimeUTC(timezone=True), nullable=False),
    sa.Column('updated_at', sa.DateTimeUTC(timezone=True), nullable=False),
    sa.CheckConstraint("status IN ('pending','confirmed','waitlisted','withdrawn')", name=op.f('ck_signups_ck_signups_status')),
    sa.ForeignKeyConstraint(['session_id'], ['sessions.id'], name=op.f('fk_signups_session_id_sessions')),
    sa.ForeignKeyConstraint(['student_id'], ['students.id'], name=op.f('fk_signups_student_id_students')),
    sa.PrimaryKeyConstraint('id', name=op.f('pk_signups')),
    sa.UniqueConstraint('session_id', 'student_id', name='uq_signups_session_student')
    )
    with op.batch_alter_table('signups', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_signups_session_id'), ['session_id'], unique=False)
    ...
    sa.Column('created_at', sa.DateTimeUTC(timezone=True), nullable=False),
    sa.Column('updated_at', sa.DateTimeUTC(timezone=True), nullable=False),
    sa.CheckConstraint("status IN ('present','absent_known','absent_unknown')", name=op.f('ck_attendance_records_ck_attendance_records_status')),
    sa.ForeignKeyConstraint(['occurrence_id'], ['occurrences.id'], name=op.f('fk_attendance_records_occurrence_id_occurrences'), ondelete='CASCADE'),
    ...
    with op.batch_alter_table('attendance_records', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_attendance_records_occurrence_id'), ['occurrence_id'], unique=False)
